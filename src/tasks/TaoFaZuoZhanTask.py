...
class TaoFaZuoZhanTask(BaseQRSLTask):
    ...
    def enter_taofa_dungeon(self):
        ...
        self._click_box_safe(attend_box, after_sleep=1.5)          # 替换
        self.log_info("等待5秒...")
        self.sleep(5)
    ...
    def execute_combat_sequence(self):
        ...
        self.send_key_safe('a', down_time=0.3)                     # 替换
        self.sleep(0.5)
        self.log_info("按W键2.7秒")
        self.send_key_safe('w', down_time=2.7)                     # 替换
        self.sleep(0.5)
        self.log_info("按F键")
        self.send_key_safe('f', down_time=0.02)                    # 替换
        self.sleep(0.5)
        self.log_info("按D键0.8秒")
        self.send_key_safe('d', down_time=0.8)                     # 替换
        self.sleep(0.5)
        self.log_info("按F键")
        self.send_key_safe('f', down_time=0.02)                    # 替换
        self.sleep(0.5)
    ...
    def exit_taofa_dungeon(self):
        ...
        self._click_safe(check_x, check_y, after_sleep=1)           # 替换
        self._click_safe(check_x, check_y, after_sleep=1)           # 替换
